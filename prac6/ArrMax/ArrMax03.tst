// Sample Test file for ArrMax(3100,6)
...
set RAM[3100] -21,  // Set Arr[0]
set RAM[3101] 41,  // Set Arr[1]
set RAM[3102] 0,  // Set Arr[2]
set RAM[3103] 11;  // Set Arr[3]
set RAM[3104] -30;  // Set Arr[4]
set RAM[3105] 12;  // Set Arr[5]
